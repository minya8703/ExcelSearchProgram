...
public class ExcelSearchProgram {

	public static void main(String[] args) {
		folderInFiles("D:\\min\\Now\\2023.07.26_인사사원정보");
	...
	private static void PoiReadExcel(File f) {
		String filePath = f.getPath().replaceAll(f.getName(), "");
